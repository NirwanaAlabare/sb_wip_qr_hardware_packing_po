    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title me-3 fw-bold text-success">Profile</h3>
                <button class="btn btn-success rounded-circle me-3 mt-1" id="enable-profile" onclick="enableForm(this, 'disable-profile', 'profile-form')"><i class="fa fa-pencil fa-sm"></i></button>
