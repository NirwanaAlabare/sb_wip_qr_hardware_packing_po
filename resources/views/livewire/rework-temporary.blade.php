                                        ...
                                        @foreach ($allDefectImage as $image)
                                            <div class="carousel-item {{ $loop->iteration == 1 ? "active" : "" }}" data-bs-interval="5000" id="carousel-item-{{ $loop->iteration }}">
                                                <div class="all-defect-area-img-container mb-3">
                                                    @if ($image)
                                                        @foreach ($allDefectPosition->where('id_ws', $image->id_ws) as $defectPosition)
                        ...
                        @else
                            @foreach ($defects as $defect)
                                <tr>
                                    ...
                                    <td class="text-defect fw-bold">{{ strtoupper($defect->tipe_output) }}</td>
                                    <td>
                                        <div wire:loading>
                                            <div class="loading-small"></div>
                                        </div>
                        ...
                        @else
                            @foreach ($reworks as $rework)
                                <tr>
                                    ...
                                    <td class="text-rework fw-bold">{{ strtoupper($rework->tipe_output) }}</td>
                                    <td>
