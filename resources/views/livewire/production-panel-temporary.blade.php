<div>
    <div wire:poll.visible.30000ms>
        ...
        {{-- Production Panels --}}
        <h5 class="text-center text-success fw-bold mb-3">Temporary Input</h5>
        <div class="production-panel row row-gap-3" id="production-panel">
            @if ($panels)
                ...
                <div class="d-flex">
                    <button class="btn btn-success w-100" wire:click='uploadToMasterPlan()'><i class="fa-regular fa-paper-plane"></i> Upload ke Master Plan</button>
                </div>
            @endif
